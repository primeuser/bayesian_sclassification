function showNdpCalendarBox(a) {
    ...
    if (calendarVisible)
        hideCalendarBox(!1);
    //else{ //removed because onclicking next datepicker it was not displaying
    ndpData[a] && (ndpAttr = ndpData[a]);

    var b = $("#" + a).val(); $("#ndp-target-id").html(a);
    var c = $("#" + a).offset();
...
function setSelectedDay(a) {
    var b = $("#ndp-target-id").html(); $("#" + b).val(a), ndpAttr.ndpEnglishInput && $("#" + ndpAttr.ndpEnglishInput).val(BS2AD(a)), hideCalendarBox()
}
...
function getMonthParameters(a) {
    var b = a.split("/"), c = b[0], d = b[1]; $("#currentMonth").html(getNepaliMonth(d - 1) + "&nbsp;" + englishNo2Nep(c)), nYear = pYear = c, nMonth = parseInt(d, 10) + 1, nMonth > 12 && (nYear++ , nMonth = "01"), pMonth = parseInt(d, 10) - 1, pMonth < 1 && (pYear-- , pMonth = "12"), $("#prev").attr("onclick", "showCalendar('" + pYear + "/" + pMonth + "/01')"), $("#next").attr("onclick", "showCalendar('" + nYear + "/" + nMonth + "/01')");
    var e = b[2], f = numberOfBsDays(c, d - 1), g = new NepaliDateConverter, h = d + "/1/" + c, i = g.bs2ad(h), j = i.split("/"), k = j[0], l = j[1], m = j[2], n = new Date(k, l - 1, m), o = n.getDay();
...
function getDateRows(a, b, c, d, e) {
    ...
    l % 7 === 0 && (k += "<tr>");
        var m = l - a + 1, n = c.toString() + "/" + get2DigitNo(d) + "/" + get2DigitNo(m), o = ""; o = get2DigitNo(d) == i && j == get2DigitNo(m) ? "ndp-selected" : m == e ? "ndp-current" : "ndp-date", a > l ? k += "<td></td>\n" : (k += "<td class='" + o + "'>", k += "<a href='javascript:void(0)' onclick=\"setSelectedDay('" + n + "')\">" + englishNo2Nep(m) + "</a>", k += "</td>\n"), l % 7 == 6 && (k += "</tr>\n")
    }
    return k
}
...
function getCurrentDayName() {
    var a = new Date, b = a.getDay(), c = new Array(7);
    return c[0] = "Sunday", c[1] = "Monday", c[2] = "Tuesday", c[3] = "Wednesday", c[4] = "Thursday", c[5] = "Friday", c[6] = "Saturday", c[b]
}
function getDayFromDate(a) {
    var b = a.split("/"), c = b[2], d = b[1], e = b[0], f = new Date(e, d - 1, c), g = f.getDay(), h = new Array("Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat");
    return h[g]
}
function numberOfBsDays(a, b) {
    var c = new NepaliDateConverter; return c.bs[a][b]
}

function numberOfDays(a, b) {
    var c = new Date(a, b, 0); return c.getDate()
}
function AD2BS(a) {
...
function getDateInWords() {
    var a = getMonths(), b = new Date, c = b.getDate(), d = b.getMonth() + 1, e = b.getYear(), f = 1e3 > e ? e + 1900 : e;
    return c + " " + a[d] + ", " + f
}
function getDateInNo(a) {
    var b = new Date, c = b.getDate(), d = b.getMonth() + 1, e = b.getFullYear();
    return d + a + c + a + e
}
function getNepaliFormat(a) {
    var b = a.split("/"), c = b[2], d = b[1], e = b[0]; return d + "/" + c + "/" + e
}

function getAdDateInWords(a) {
    var b = getMonths(), c = a.split("/"), d = c[2], e = c[1], f = c[0];
    return d + " " + b[e] + ", " + f
}
function getNepaliDateInWords(a) {
    var b = getNepaliMonths(), c = a.split("/"), d = c[2], e = c[1], f = c[0];
    return d + " " + b[e] + ", " + f
}
...
function NepaliDateConverter() {
    this.bs_date_eq = "09/17/2000", this.ad_date_eq = "01/01/1944",
        this.bs = [], this.bs[2e3] = new Array(30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31),
        ...
        this.count_ad_days = count_ad_days, this.count_bs_days = count_bs_days, this.add_bs_days = add_bs_days, this.add_ad_days = add_ad_days, this.bs2ad = bs2ad, this.ad2bs = ad2bs
}

function count_ad_days(a, b) {
    var c = 864e5, d = a.split("/"), e = b.split("/");
    d[2] = Number(d[2]), d[1] = Number(d[1]),
        d[0] = Number(d[0]), e[2] = Number(e[2]),
        e[1] = Number(e[1]), e[0] = Number(e[0]);
...
function count_bs_days(a, b) {
    var c = a.split("/"), d = b.split("/"),
        e = Number(c[2]), f = Number(c[0]),
        g = Number(c[1]), h = Number(d[2]), i = Number(d[0]),
        j = Number(d[1]), k = 0, l = 0; for (l = e; h >= l; l++)k += arraySum(this.bs[l]);
...
function add_bs_days(a, b) {
    var c = a.split("/"), d = Number(c[2]), e = Number(c[0]), f = Number(c[1]);
    ...
    function (a) {
        a.fn.nepaliDatePicker = function (b) {
            b = "undefined" != typeof b ? b : {}, ndpAttr = b, this.each(function () {
                var c = a(this).attr("id"); a(this).addClass("ndp-nepali-calendar"), ndpData[c] = b, ndpAttr.onFocus !== !1 && a(this).attr("onfocus", "showNdpCalendarBox('" + c + "')"), ndpAttr.ndpTriggerButton && a(this).after('<button type="button" class="ndp-click-trigger ' + (ndpAttr.ndpTriggerButtonClass ? ndpAttr.ndpTriggerButtonClass : "") + '" onclick="showNdpCalendarBox(&quot;' + c + '&quot;)">' + (ndpAttr.ndpTriggerButtonText ? ndpAttr.ndpTriggerButtonText : "Pick Date") + "</button>")
            }),
...
var mouse_is_inside = !1, calendarDivString = '<div id="ndp-nepali-box" class="ndp-corner-all" style="display:none">'; calendarDivString += '<span id="ndp-target-id" style="display:none"></span>', calendarDivString += '<div class="ndp-corner-all ndp-header">', calendarDivString += '<a href="javascript:void(0)" id="prev" title="Previous Month" class="ndp-prev"></a>', calendarDivString += '<a href="javascript:void(0)" id="next" title="Next Month" class="ndp-next"></a>',
