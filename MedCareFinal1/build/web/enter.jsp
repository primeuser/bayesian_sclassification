    ...
    <div class="row">
        ...
        <div class="container">
            <div class="well-sm col-lg-12">
                ...
                <div class="col-lg-6">
                    <li class="" ><a class="page-scroll" href="admin.jsp"  title="Services"><h2>Admin Login</h2></a></li>
                    <br>
                    <h2 class="mar-10-btm"> User Login</h2>
                       <form method="post" action="LoginServlet" id="searchform" >

                        <div class="form-group">
                            <label for="username"><h2>Email:</h2></label>
                            <input type="email" id="email" required="" placeholder="Username" name="email" required />
                        </div>
                        ...
                        <p class="text-right">
                            <input class="wpcf7-submit btn btn-primary text-right" type="submit" value="Log in">
                        </p>
                    </form>
                </div>
                <div class="col-lg-3"></div>
